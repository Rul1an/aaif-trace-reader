...
| IC-5 | Turn order and turn state are not answered in v0.2; the report carries the turn set and `order: not_answered` with the reason | lines 86, 142 | derive order from timestamps or span tree |
